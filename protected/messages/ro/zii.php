...
return array (
  ...
  'The button type "{type}" is not supported.' => 'Buttonul de tipul "{type}" nu este compatibil cu sistemul.',
  'Are you sure you want to delete this item?' => 'Precis doriți să ștergeți?',
  'Delete' => 'Șterge',
  'Displaying {start}-{end} of {count} result(s).' => 'Afișare {start}—{end} din {count}.',
  'Either "name" or "value" must be specified for CDataColumn.' => 'Pentru CDataColumn este necesar de a indica proprietățile "name" sau "value".',
  'No results found.' => 'Nu a fost găsit nici un rezultat.',
  ...
  'Total {count} result(s).' => 'Total rezultate: {count}.',
  'Update' => 'Editare',
  'View' => 'Afișare',
